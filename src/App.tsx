...
// ── Color tokens ──────────────────────────────────────────────────────────────
// bg:      #050517  (deep navy black)
// card:    #0a0a2e  (dark navy)
// dark:    #050517
// orange:  #FF4E00  (accent)
// orange2: #FF7A3D  (light accent / hover)
// text:    #ffffff
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050517] text-white selection:bg-[#FF4E00] selection:text-[#050517] font-sans overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[1000] border-b border-[#FF4E00]/20 bg-[#050517]/95 backdrop-blur-md">
        <div className="flex items-center justify-between px-4 md:px-8 py-3 md:py-4 text-[10px] md:text-xs font-mono uppercase tracking-widest">
          <div className="flex items-center gap-2">
            ...
            <Link to="/" className="font-bold tracking-tighter text-white hover:text-[#FF4E00] transition-colors">ОКО ГОРА</Link>
          </div>
          {/* Desktop nav links */}
          <div className="hidden md:flex items-center gap-6 text-white/50">
            ...
            <Link to="/targets" className="hover:text-white transition-colors flex items-center gap-1 text-[#FF4E00] font-bold">
            ...
            <a href="https://t.me/oko_gora" target="_blank" rel="noreferrer"
              className="hover:text-[#FF4E00] transition-colors flex items-center gap-1 font-bold text-white">
          ...
          <button
            ...
            aria-label="Меню"
          >
            <span className={`block w-5 h-[2px] bg-[#FF4E00] transition-all duration-300 ${mobileMenuOpen ? 'rotate-45 translate-y-[7px]' : ''}`} />
            <span className={`block w-5 h-[2px] bg-[#FF4E00] transition-all duration-300 ${mobileMenuOpen ? 'opacity-0' : ''}`} />
            <span className={`block w-5 h-[2px] bg-[#FF4E00] transition-all duration-300 ${mobileMenuOpen ? '-rotate-45 -translate-y-[7px]' : ''}`} />
          </button>
        </div>
        {/* Mobile dropdown */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-[#FF4E00]/20 bg-[#050517] px-4 py-4 flex flex-col gap-4 font-mono text-[11px] uppercase tracking-widest">
            <Link to="/" className="text-white/60 hover:text-[#FF4E00] transition-colors py-1" onClick={() => setMobileMenuOpen(false)}>Головна</Link>
            <Link to="/targets" className="text-[#FF4E00] font-bold flex items-center gap-1 py-1" onClick={() => setMobileMenuOpen(false)}>
              <Target className="w-3 h-3" /> БАЗА ЦІЛЕЙ
            </Link>
            <button type="button" onClick={() => openSection('map')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">Карта</button>
            <button type="button" onClick={() => openSection('brigades')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">Підрозділи</button>
            <button type="button" onClick={() => openSection('analytics')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">Аналітика</button>
            <button type="button" onClick={() => openSection('sbs')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">SBS</button>
            <button type="button" onClick={() => openSection('deepstate')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">DeepState</button>
            <button type="button" onClick={() => openSection('investigations')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">Розслідування</button>
            <button type="button" onClick={() => openSection('rss')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">RSS</button>
            <button type="button" onClick={() => openSection('feed')} className="text-left text-white/60 hover:text-[#FF4E00] transition-colors py-1">Стрічка</button>
            <a href="https://t.me/oko_gora" target="_blank" rel="noreferrer"
              className="text-white font-bold flex items-center gap-1 py-1 hover:text-[#FF4E00] transition-colors">
              ТЕЛЕГРАМ <ArrowUpRight className="w-3 h-3" />
            </a>
          </div>
        )}
        ...
        >
          ...
          <motion.div variants={fadeIn} className="mb-16 md:mb-32 relative overflow-hidden">
            <div className="absolute inset-0 -z-20 pointer-events-none select-none">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-[#050517]/30 via-[#050517]/75 to-[#050517]" />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-5 mb-10 relative z-10">
              <div className="flex flex-col items-center gap-1.5 group cursor-default" title="Нарукавний знак ЗСУ">
                <div className="w-14 h-14 flex items-center justify-center border border-[#FF4E00]/30 bg-[#FF4E00]/10 group-hover:border-[#FF4E00]/70 group-hover:bg-[#FF4E00]/20 transition-all duration-300 p-1.5">
                  <img
                    src="assets-zsu-patch.png"
                ...
                <span className="font-mono text-[8px] tracking-widest text-[#FF4E00]/70 group-hover:text-[#FF4E00] transition-colors uppercase">ЗСУ</span>
              </div>
              {[
                ...
                <div key={branch.label} className="flex flex-col items-center gap-1.5 group cursor-default" title={branch.title}>
                  <div className="w-14 h-14 flex items-center justify-center border border-[#FF4E00]/20 bg-[#FF4E00]/5 group-hover:border-[#FF4E00]/60 group-hover:bg-[#FF4E00]/10 transition-all duration-300 p-1">
                    <img
                      src={branch.url}
                      alt={branch.title}
                      className="w-full h-full object-contain"
                  ...
                  <span className="font-mono text-[8px] tracking-widest text-[#FF4E00]/50 group-hover:text-[#FF4E00] transition-colors uppercase">{branch.label}</span>
                </div>
              ))}
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="ml-auto hidden md:inline-flex items-center gap-1.5 font-mono text-[9px] text-[#FF7A3D]/55 hover:text-[#FF7A3D] uppercase tracking-widest transition-colors"
              >
                t.me/oko_gora <ArrowUpRight className="w-3 h-3" />
              </a>
            </div>
            <div className="mb-8 md:mb-12 flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-l-2 border-[#FF4E00]/80 bg-[#050517]/70 p-4 md:p-5">
              <div>
                <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-2">/ ПЛАТФОРМА TELEGRAM-КАНАЛУ</p>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 self-start md:self-auto shrink-0 border border-[#FF4E00]/60 bg-[#FF4E00]/12 px-4 py-3 font-mono text-[11px] md:text-xs tracking-widest uppercase text-[#FF7A3D] hover:bg-[#FF4E00]/20 hover:border-[#FF4E00] transition-colors"
              >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-10 md:mb-14">
              {heroSignals.map((signal) => (
                <div key={signal.label} className="border border-[#FF4E00]/20 bg-[#050517]/80 p-4 md:p-5">
                  <p className="font-mono text-[9px] uppercase tracking-widest text-white/42">{signal.label}</p>
                  <p className="mt-2 text-3xl md:text-5xl font-black tracking-tighter text-[#FF7A3D] tabular-nums">{formatNumber(signal.value)}</p>
          ...
          <motion.section id="investigations" variants={fadeIn} className="mb-32 md:mb-48 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ НОВИЙ РОЗДІЛ</span>
                  <h2 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase leading-[0.9]">Інтерактивні розслідування</h2>
                </div>
                <a href="https://t.me/oko_gora" target="_blank" rel="noreferrer"
                  className="font-mono text-xs uppercase tracking-widest text-white/30 hover:text-[#FF4E00] transition-colors">
                  Telegram-канал <ArrowUpRight className="inline w-3 h-3 ml-1" />
                </a>
              </div>

              <div className="mb-6 border border-[#FF4E00]/30 bg-[#050517] p-5 md:p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 border border-[#FF4E00]/40 bg-[#FF4E00]/10 flex items-center justify-center shrink-0">
                    <Database className="w-5 h-5 text-[#FF4E00]" />
                  </div>
                  <div>
                    <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/80">Розділ відкрито</p>
              ...
              {featuredInvestigation && (
                <article className="mb-5 bg-[#050517] border border-[#FF4E00]/45 p-6 md:p-8 lg:p-10">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-end">
                    <div className="lg:col-span-8">
                      <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4">{featuredInvestigation.code}</p>
                    ...
                    <div className="lg:col-span-4 flex lg:justify-end">
                      <Link to={`/investigation/${featuredInvestigation.id}`} className="inline-flex items-center gap-2 border border-[#FF4E00]/50 bg-[#FF4E00]/10 px-5 py-4 font-mono text-[10px] uppercase tracking-widest text-[#FF7A3D] hover:bg-[#FF4E00]/20 transition-colors">
              ...
              {investigationCards.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <article key={item.code} className="bg-[#0a0a2e] border border-[#FF4E00]/20 p-6 md:p-8 hover:border-[#FF4E00]/50 transition-colors">
                    <p className="font-mono text-[9px] uppercase tracking-[0.25em] text-[#FF4E00] mb-4">{item.code}</p>
                    ...
                    <div className="mt-4 flex items-center gap-4">
                      <Link to={`/investigation/${item.id}`} className="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-white/65 hover:text-[#FF4E00] transition-colors">
                        Детально <ArrowUpRight className="w-3 h-3" />
                      </Link>
                      {item.url && (
                        <a href={item.url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-white/45 hover:text-[#FF4E00] transition-colors">
          ...
          <motion.div id="map" variants={fadeIn} className="mb-32 md:mb-48 w-full scroll-mt-28">
            <Suspense fallback={
              <div className="w-full h-[500px] md:h-[800px] bg-[#050517] border border-[#FF4E00]/20 flex items-center justify-center">
                <span className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/40 animate-pulse">ЗАВАНТАЖЕННЯ_МАПИ...</span>
              </div>
            }>
              <MapService />
            </Suspense>
          ...
          <motion.div variants={fadeIn} className="mb-32 md:mb-48">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Terminal */}
              <div className="lg:col-span-1 bg-[#050517] text-[#FF4E00] p-6 font-mono text-[10px] leading-relaxed border border-[#FF4E00]/25 shadow-2xl relative overflow-hidden">
                <div className="flex items-center gap-2 mb-4 border-b border-[#FF4E00]/20 pb-2">
                ...
                <div className="space-y-1 opacity-80 h-[120px] overflow-hidden text-white/70">
                  ...
                  <p className="animate-pulse text-[#FF4E00]">_</p>
                </div>
                <div className="mt-8 pt-4 border-t border-[#FF4E00]/10 flex justify-between opacity-30 text-[8px] uppercase tracking-widest">
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#0a0a2e] border border-[#FF4E00]/20 p-8 hover:border-[#FF4E00]/60 hover:bg-[#0d0d2a] transition-all duration-500 group relative">
                  <Activity className="w-8 h-8 mb-6 text-[#FF4E00]/40 group-hover:text-[#FF4E00] transition-colors" />
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-6 font-mono text-center">
                    <div className="border border-[#FF4E00]/20 py-2">
                      <div className="text-lg font-bold text-[#FF4E00]">{pechalStats?.counters.today ?? 0}</div>
                  ...
                  <div className="mb-5 border border-[#FF4E00]/18 bg-[#050517]/55 p-3 font-mono text-[9px] uppercase tracking-widest text-white/42">
                    ...
                    <div className="mt-2 flex items-center justify-between gap-3">
                      ...
                      {pechalStats?.latestProofs?.[0]?.url ? (
                        <a href={pechalStats.latestProofs[0].url} target="_blank" rel="noreferrer" className="text-[#FF4E00] hover:text-[#FF7A3D] transition-colors">
                  ...
                  <div className="flex justify-between items-center font-mono text-[10px] tracking-widest pt-4 border-t border-white/10">
                    <a href={pechalStats?.sourceUrl || 'https://t.me/s/pechalbeda200'} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-[#FF4E00] hover:text-[#FF7A3D] transition-colors"><Shield className="w-3 h-3" /> Відкрити канал</a>
                    <span className="text-white/30">*номер у пості</span>
                  </div>
                </div>

                <Link to="/targets" className="bg-[#0a0a2e] border border-[#FF4E00]/20 p-8 hover:border-[#FF4E00]/60 hover:bg-[#0d0d2a] transition-all duration-500 group relative block">
                  <Database className="w-8 h-8 mb-6 text-[#FF4E00]/40 group-hover:text-[#FF4E00] transition-colors" />
                  ...
                  <div className="flex justify-between items-center font-mono text-[10px] tracking-widest pt-4 border-t border-white/10">
                    <span className="flex items-center gap-2 text-[#FF4E00]"><Shield className="w-3 h-3" /> 38+ ОБ'ЄКТІВ</span>
                    <span className="text-white/30 group-hover:text-[#FF4E00] flex items-center gap-1 transition-colors">ВІДКРИТИ <ArrowUpRight className="w-3 h-3" /></span>
                  </div>
                </Link>
              </div>
            </div>
            ...
            {/* Dashboard strip */}
            <div className="mt-8 aspect-[21/4] w-full bg-[#050517] relative overflow-hidden group border border-[#FF4E00]/10">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[#050517] via-transparent to-[#050517]" />
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="text-[#FF4E00]/30 font-mono text-[10px] tracking-[0.5em] uppercase">
          ...
          <motion.section id="brigades" variants={fadeIn} className="mb-32 md:mb-48 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ UNITS DASHBOARD</span>
                ...
                <div className="bg-[#050517] border border-[#FF4E00]/20 px-6 py-5 min-w-[260px]">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">Статус вибірки</p>
              ...
              {!brigadeDashboard || !brigadeDashboard.brigades.length ? (
                <div className="border border-[#FF4E00]/20 bg-[#0a0a2e] p-8 font-mono text-xs uppercase tracking-widest text-white/40">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                  {brigadeDashboard.brigades.map((row) => (
                    <article key={row.id} className="bg-[#0a0a2e] border border-[#FF4E00]/20 p-5 md:p-6">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mb-4 font-mono text-center">
                        <div className="border border-[#FF4E00]/20 py-2">
                          <div className="text-base font-bold text-[#FF4E00]">{row.officialItems}</div>
                      ...
                      {row.items.length === 0 ? (
                        ...
                        <div className="space-y-3">
                          {row.items.slice(0, 3).map((item) => (
                            <a key={item.id} href={item.url} target="_blank" rel="noreferrer" className="block border border-white/10 p-3 hover:border-[#FF4E00]/45 transition-colors">
                              <div className="flex items-center justify-between mb-2 font-mono text-[9px] tracking-widest uppercase">
                                <span className={item.origin === 'official' ? 'text-[#FF4E00]' : 'text-white/50'}>{item.origin === 'official' ? 'Офіційний паб' : 'Моніторинг згадок'}</span>
                              ...
                              <div className="mt-2 flex flex-wrap gap-2">
                                {item.isStrike && (
                                  <span className="px-2 py-0.5 border border-[#FF4E00]/40 text-[9px] font-mono uppercase tracking-widest text-[#FF4E00]">Ураження</span>
                                )}
                                {item.isReorg && (
          ...
          <motion.section id="analytics" variants={fadeIn} className="mb-32 md:mb-48 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ OSINT DASHBOARD</span>
                ...
                <div className="bg-[#050517] border border-[#FF4E00]/20 px-6 py-5">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">Унікальних згадок (7 днів)</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div className="border border-[#FF4E00]/20 bg-[#050517] p-4">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">Що це за метрика</p>
                ...
                <div className="border border-[#FF4E00]/20 bg-[#050517] p-4">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">Що показує heatmap</p>
                ...
                <div className="border border-[#FF4E00]/20 bg-[#050517] p-4">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">Що показує тренд</p>
                ...
                <div className="border border-[#FF4E00]/20 bg-[#050517] p-4">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">Що таке “Конкретика”</p>
              ...
              <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
                <div className="border border-white/10 bg-[#050517] p-4">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                <div className="xl:col-span-7 bg-[#050517] border border-[#FF4E00]/20 p-6 md:p-8">
                  <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">Heatmap · День × Область</h3>
                    ...
                    {dashboard.days.map((day) => (
                      <div key={day} className="grid gap-2 items-center" style={{ gridTemplateColumns: `70px repeat(${Math.max(1, dashboard.oblasts.length)}, minmax(0, 1fr))` }}>
                        ...
                        {dashboard.oblasts.map((oblast) => {
                          ...
                          return (
                            <div key={`${day}-${oblast}`} className="h-8 border border-[#FF4E00]/20 flex items-center justify-between px-2" style={{ backgroundColor: `rgba(255,78,0,${alpha})` }}>
                ...
                <div className="xl:col-span-5 bg-[#0a0a2e] border border-[#FF4E00]/20 p-6 md:p-8">
                  <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">Тренд · День</h3>
                  ...
                  <div className="space-y-2">
                    {dashboard.trend.map((t) => (
                      <div key={t.day} className="flex items-center gap-3">
                        ...
                        <div className="h-3 bg-[#FF4E00] transition-all" style={{ width: `${Math.max(6, (t.total / dashboard.maxTrend) * 100)}%` }} />
                        <span className="font-mono text-[10px] text-white/75">{t.total}</span>
                      </div>
                    ))}
                  </div>
                  <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mt-8 mb-3">Топ-області</h3>
                  <div className="space-y-2">
                    {dashboard.concreteByOblast.slice(0, 6).map((row) => (
                      <div key={row.oblast} className="flex items-center justify-between border-b border-white/10 pb-1">
                        ...
                        <span className="font-mono text-[10px] text-[#FF4E00]">{row.total}</span>
                      </div>
                    ))}
                  </div>
                  <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mt-8 mb-3">Джерела (7 днів)</h3>
                  <div className="space-y-2 font-mono text-[10px] uppercase tracking-widest">
                    <div className="flex items-center justify-between border-b border-white/10 pb-1"><span className="text-white/60">X / Twitter</span><span className="text-[#FF4E00]">{dashboard.bySource.x}</span></div>
                    <div className="flex items-center justify-between border-b border-white/10 pb-1"><span className="text-white/60">Facebook</span><span className="text-[#FF4E00]">{dashboard.bySource.facebook}</span></div>
                    <div className="flex items-center justify-between border-b border-white/10 pb-1"><span className="text-white/60">Telegram</span><span className="text-[#FF4E00]">{dashboard.bySource.telegram}</span></div>
                  </div>
                </div>
              </div>

              <div className="mt-6 bg-[#050517] border border-[#FF4E00]/20 p-6 md:p-8">
                <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-4">Конкретика по областях</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {dashboard.concreteByOblast.map((row) => (
                    <div key={row.oblast} className="border border-[#FF4E00]/20 bg-[#0a0a2e] p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]">{row.oblast}</span>
                      ...
                      <div className="space-y-2">
                        {row.samples.length === 0 ? (
                          ...
                          <a key={`${row.oblast}-${s.day}-${s.url}`} href={s.url} target="_blank" rel="noreferrer" className="block text-sm text-white/80 leading-snug hover:text-[#FF4E00] transition-colors">
                            • [{s.source}] {s.headline}
              ...
              <div className="mt-6 bg-[#050517] border border-[#FF4E00]/20 p-6 md:p-8">
                <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-4">Методологія підрахунку</h3>
          ...
          <motion.section id="sbs" variants={fadeIn} className="mb-32 md:mb-48 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ SBS STATS</span>
                ...
                <a href="https://foosint.github.io/sbs-stats/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border border-[#FF4E00]/60 bg-[#FF4E00]/12 px-4 py-2 font-mono text-[11px] md:text-xs tracking-widest uppercase text-[#FF7A3D] hover:bg-[#FF4E00]/20 hover:border-[#FF4E00] transition-colors">
                  Відкрити джерело <ArrowUpRight className="w-3.5 h-3.5" />
                </a>
              </div>
              <div className="relative overflow-hidden border border-[#FF4E00]/25 bg-[#050517]">
                <div className="absolute inset-0 opacity-25" style={{ backgroundImage: 'linear-gradient(rgba(255,78,0,0.12) 1px, transparent 1px), linear-gradient(90deg, rgba(255,78,0,0.12) 1px, transparent 1px)', backgroundSize: '34px 34px' }} />
                <div className="absolute -right-28 -top-28 w-[520px] h-[520px] border border-[#FF4E00]/20 rounded-full" />
                <div className="relative grid grid-cols-1 xl:grid-cols-12 gap-6 p-5 md:p-8">
                  <div className="xl:col-span-4 border border-[#FF4E00]/25 bg-[#050517]/90 p-5 md:p-7">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">останній зріз</p>
                      ...
                      <RadioTower className="w-8 h-8 text-[#FF4E00] shrink-0" />
                    </div>
                    <div className="grid grid-cols-2 gap-3 mt-7">
                      {[
                        ...
                        <div key={label as string} className="border border-[#FF4E00]/18 bg-[#050517]/80 p-4">
                          <p className="font-mono text-[9px] uppercase tracking-widest text-white/42">{label}</p>
                          <p className="mt-2 text-3xl font-black tracking-tighter text-[#FF7A3D] tabular-nums">{formatNumber(value as number)}</p>
                  ...
                  <div className="xl:col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="lg:col-span-2 border border-[#FF4E00]/20 bg-[#050517]/85 p-5">
                      <div className="flex items-center justify-between gap-4 mb-5">
                        <div>
                          <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">категорії уражень</p>
                          <h4 className="text-2xl font-extrabold uppercase leading-none mt-1">Що саме фіксує SBS</h4>
                        </div>
                        <BarChart3 className="w-7 h-7 text-[#FF4E00]" />
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {(sbsTopCategories.length ? sbsTopCategories : [{ id: 0, label: 'Очікуємо синхронізацію', hit: 0, destroyed: 0 }]).map((item) => (
                          <div key={item.id} className="border border-[#FF4E00]/18 bg-[#050517]/70 p-4">
                            <div className="flex items-center justify-between gap-3">
                              <p className="text-base md:text-lg font-extrabold uppercase leading-tight">{item.label}</p>
                              <p className="font-mono text-[10px] text-[#FF7A3D] shrink-0">hit {formatNumber(item.hit)}</p>
                            </div>
                            <div className="mt-3 h-2 bg-white/10">
                              <div className="h-full bg-[#FF4E00]" style={{ width: `${Math.max(3, ((item.hit + item.destroyed) / sbsMaxCategory) * 100)}%` }} />
                            </div>
                    ...
                    <div className="border border-[#FF4E00]/20 bg-[#050517]/80 p-5">
                      <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-4">добовий тренд hit</p>
                      <div className="space-y-2">
                        {sbsTrend.map((row) => (
                          <div key={`${row.date}-${row.hour}`} className="grid grid-cols-[76px_1fr_52px] items-center gap-3">
                            ...
                            <div className="h-3 bg-white/10">
                              <div className="h-full bg-[#FF4E00]" style={{ width: `${Math.max(4, (row.targetsHit / sbsMaxDaily) * 100)}%` }} />
                            </div>
                    ...
                    <div className="border border-[#FF4E00]/20 bg-[#050517]/80 p-5">
                      <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-4">методологія</p>
          ...
          <motion.section id="deepstate" variants={fadeIn} className="mb-32 md:mb-48 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ DEEPSTATE TABLE</span>
                ...
                <a href="https://deepstat.xyz/table" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border border-[#FF4E00]/60 bg-[#FF4E00]/12 px-4 py-2 font-mono text-[11px] md:text-xs tracking-widest uppercase text-[#FF7A3D] hover:bg-[#FF4E00]/20 hover:border-[#FF4E00] transition-colors">
                  Відкрити DeepState <ArrowUpRight className="w-3.5 h-3.5" />
                </a>
              </div>
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                <div className="xl:col-span-7 border border-[#FF4E00]/25 bg-[#050517] p-5 md:p-7 overflow-hidden">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">data-diff matrix</p>
                    ...
                    <MapPinned className="w-8 h-8 text-[#FF4E00]" />
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                    {[
                      ...
                      <div key={label} className="border border-[#FF4E00]/18 bg-[#050517]/80 p-4">
                        <p className="font-mono text-[9px] uppercase tracking-widest text-white/42">{label}</p>
                        <p className="mt-2 text-xl md:text-2xl font-black tracking-tighter text-[#FF7A3D] tabular-nums">{value}</p>
                  ...
                  <div className="grid grid-cols-4 md:grid-cols-8 gap-2 min-h-[220px]">
                    {(deepstateRows.length ? deepstateRows : Array.from({ length: 8 }, (_, i) => ({ day: `${i + 1}`, diffKm2: 0, text: 'Очікуємо дані', occupiedKm2: 0, occupiedPercent: 0 }))).map((row, i) => {
                      ...
                      return (
                        <div
                          key={`${row.day}-${i}`}
                          className={`relative min-h-[120px] border p-3 flex flex-col justify-between ${isRelease ? 'border-sky-300/40 bg-sky-400/15' : 'border-[#FF4E00]/35 bg-[#FF4E00]/15'}`}
                          style={{ opacity: 0.48 + intensity * 0.52 }}
                          title={row.text}
                        >
                          <span className="font-mono text-[10px] text-white/60">день {row.day}</span>
                          <span className={`text-2xl font-black tracking-tighter tabular-nums ${isRelease ? 'text-sky-200' : 'text-[#FF7A3D]'}`}>{formatSignedKm2(row.diffKm2)}</span>
                          <span className="font-mono text-[9px] uppercase tracking-widest text-white/38">{isRelease ? 'звільнення' : 'просування ворога'}</span>
                        </div>
                      );
                    })}
                  </div>
                  <div className="mt-5 border border-white/10 bg-[#050517]/70 p-4">
                    <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-2">останнє пояснення</p>
                ...
                <div className="xl:col-span-5 border border-[#FF4E00]/25 bg-[#050517] p-5 md:p-7">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">table rows</p>
                      <h3 className="text-2xl font-extrabold uppercase leading-none mt-2">Пояснення з рядків</h3>
                    </div>
                    <Table2 className="w-7 h-7 text-[#FF4E00]" />
                  </div>
                  <div className="space-y-3 max-h-[560px] overflow-y-auto pr-1">
                    {deepstateRows.map((row) => (
                      <div key={`${row.day}-${row.text}`} className="grid grid-cols-[1fr_auto] gap-4 items-start border-b border-white/10 pb-3">
                        <div>
                          <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70">рядок {row.day} · {row.occupiedPercent.toFixed(3)}%</p>
                        ...
                        <span className={`font-mono text-[9px] uppercase tracking-widest border px-2 py-1 shrink-0 ${row.diffKm2 > 0 ? 'border-sky-300/35 text-sky-200' : 'border-[#FF4E00]/35 text-[#FF7A3D]'}`}>{formatSignedKm2(row.diffKm2)}</span>
                      </div>
                    ))}
                  ...
                  <a href="https://deepstat.xyz/table" target="_blank" rel="noreferrer" className="mt-6 flex items-center justify-between border border-[#FF4E00]/30 bg-[#FF4E00]/10 p-4 font-mono text-[10px] uppercase tracking-widest text-[#FF7A3D] hover:bg-[#FF4E00]/15 transition-colors">
          ...
          <motion.section id="rss" variants={fadeIn} className="mb-32 md:mb-48 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ LIVE RSS</span>
                ...
                <a href="https://x.com" target="_blank" rel="noreferrer"
                  className="inline-flex items-center gap-2 self-start lg:self-auto border border-[#FF4E00]/45 bg-[#FF4E00]/10 px-4 py-3 font-mono text-[11px] uppercase tracking-widest text-[#FF7A3D] hover:bg-[#FF4E00]/16 transition-colors shrink-0">
                  Перевірити X <ArrowUpRight className="w-3.5 h-3.5" />
                </a>
              </div>

              <div className="mb-6 grid grid-cols-1 xl:grid-cols-12 gap-4">
                <div className="xl:col-span-5 border border-[#FF4E00]/20 bg-[#050517]/80 p-4 md:p-5">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-3">швидкий пошук</p>
                  <input
                    value={rssSearch}
                    onChange={(e) => setRssSearch(e.target.value)}
                    placeholder="Пошук: Pokrovsk, drone, СБС, reorg..."
                    className="w-full bg-[#050517] border border-[#FF4E00]/25 px-4 py-3 text-base font-bold text-white placeholder:text-white/28 outline-none focus:border-[#FF4E00]/70 transition-colors"
                  />
                </div>
                <div className="xl:col-span-4 border border-[#FF4E00]/20 bg-[#050517]/80 p-4 md:p-5">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-3">джерело</p>
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`border px-3 py-2 text-left transition-colors ${rssSourceFilter === id ? 'border-[#FF4E00] bg-[#FF4E00]/18 text-[#FF7A3D]' : 'border-white/10 bg-white/[0.03] text-white/52 hover:text-white hover:border-[#FF4E00]/40'}`}
                      >
                ...
                <div className="xl:col-span-3 border border-[#FF4E00]/20 bg-[#050517]/80 p-4 md:p-5">
                  <p className="font-mono text-[10px] uppercase tracking-widest text-[#FF4E00]/70 mb-3">результат</p>
                  <div className="flex items-end justify-between gap-4">
                    <div>
                      <p className="text-4xl font-black tracking-tighter text-[#FF7A3D] tabular-nums">{formatNumber(rssFeed.length)}</p>
                      <p className="text-xs text-white/45 font-bold">карток після фільтрів</p>
                    </div>
                    <Rss className="w-8 h-8 text-[#FF4E00]/60 mb-1" />
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-3 py-2 border font-mono text-[10px] uppercase tracking-widest transition-colors ${rssTopicFilter === 'all' ? 'border-[#FF4E00] bg-[#FF4E00]/18 text-[#FF7A3D]' : 'border-white/10 text-white/45 hover:text-white hover:border-[#FF4E00]/40'}`}
                >
                  Усі теми
                </button>
                {rssTopics.map((topic) => (
                  <button
                    ...
                    className={`px-3 py-2 border font-mono text-[10px] uppercase tracking-widest transition-colors ${rssTopicFilter === topic.tag ? 'border-[#FF4E00] bg-[#FF4E00]/18 text-[#FF7A3D]' : 'border-white/10 text-white/45 hover:text-white hover:border-[#FF4E00]/40'}`}
                  >
              ...
              {rssItems.length + fbItems.length === 0 ? (
                <div className="border border-[#FF4E00]/20 bg-[#0a0a2e] p-8 font-mono text-xs uppercase tracking-widest text-white/30">
                  Дані RSS ще оновлюються. Перевір через кілька хвилин.
                </div>
              ) : rssFeed.length === 0 ? (
                <div className="border border-[#FF4E00]/20 bg-[#0a0a2e] p-8">
                  ...
                  <button type="button" onClick={() => { setRssSearch(''); setRssSourceFilter('all'); setRssTopicFilter('all'); }} className="mt-5 border border-[#FF4E00]/40 px-4 py-3 font-mono text-[10px] uppercase tracking-widest text-[#FF7A3D] hover:bg-[#FF4E00]/10 transition-colors">
                    Скинути фільтри
                  </button>
                </div>
              ) : (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                  {rssFeed.slice(0, 24).map((item, index) => (
                    <article
                      ...
                      className={`${index === 0 ? 'lg:col-span-6 lg:row-span-2' : 'lg:col-span-3'} group relative overflow-hidden border border-[#FF4E00]/18 bg-[#050517] hover:border-[#FF4E00]/55 transition-colors shadow-[0_14px_45px_rgba(0,0,0,0.24)]`}
                    >
                      <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#FF4E00] via-[#FF7A3D] to-transparent opacity-60" />
                      <div className="p-5 md:p-6 flex min-h-full flex-col">
                        <div className="flex items-start justify-between gap-4 mb-5">
                          <div>
                            <p className="font-mono text-[9px] uppercase tracking-[0.24em] text-[#FF4E00]/75">{item.sourceLabel}</p>
                            <p className="mt-1 font-mono text-[10px] tracking-wider text-white/38">@{item.handle || item.author}</p>
                          </div>
                          <span className="shrink-0 border border-[#FF4E00]/22 bg-[#FF4E00]/8 px-2 py-1 font-mono text-[9px] uppercase tracking-widest text-[#FF7A3D]/80">
                            {formatRssDate(item.publishedAt)}
                          </span>
                        </div>
                        <h3 className={`${index === 0 ? 'text-2xl md:text-4xl' : 'text-xl md:text-2xl'} font-black tracking-tight mb-4 leading-[1.05] text-white group-hover:text-[#FF7A3D] transition-colors`}>
                        ...
                        <div className="mt-auto">
                          <div className="flex flex-wrap gap-2 mb-4">
                            {item.tagsClean.slice(0, index === 0 ? 5 : 3).map(tag => (
                              <button
                                ...
                                className="px-2.5 py-1 border border-[#FF4E00]/20 font-mono text-[8px] uppercase tracking-widest text-[#FF4E00]/62 hover:text-[#FF7A3D] hover:border-[#FF4E00]/50 transition-colors"
                              >
                                {tag}
                              </button>
                            ))}
                          ...
                          <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-white/10">
                            <a href={item.url} target="_blank" rel="noreferrer"
                              className="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-white/65 hover:text-[#FF4E00] transition-colors">
                              Відкрити пост <ArrowUpRight className="w-3 h-3" />
                            </a>
                            <button
                              type="button"
                              onClick={() => shareLink(item.id, item.titleClean, item.url)}
                              className="font-mono text-[10px] uppercase tracking-widest text-white/45 hover:text-[#FF4E00] transition-colors"
                            >
          ...
          <motion.section id="feed" variants={fadeIn} className="mb-32 scroll-mt-28">
            <div className="border-t border-[#FF4E00]/30 pt-12 md:pt-16">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5 border-b border-[#FF4E00]/22 pb-7 mb-8 md:mb-10">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00] mb-4 block">/ ПУБЛІКАЦІЇ КАНАЛУ</span>
                ...
                <a href="https://t.me/oko_gora" target="_blank" rel="noreferrer"
                  className="inline-flex items-center gap-2 self-start lg:self-auto border border-[#FF4E00]/45 bg-[#FF4E00]/10 px-4 py-3 font-mono text-[11px] uppercase tracking-widest text-[#FF7A3D] hover:bg-[#FF4E00]/16 hover:border-[#FF4E00]/70 transition-colors">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 md:gap-6">
                {posts.map((post, index) => {
                  ...
                  return (
                    <article
                      key={post.id}
                      className={`${isLead ? 'lg:col-span-6 lg:row-span-2' : 'lg:col-span-3'} group overflow-hidden border border-[#FF4E00]/18 bg-[#050517] hover:border-[#FF4E00]/55 transition-colors shadow-[0_18px_55px_rgba(0,0,0,0.24)]`}
                    >
                      <Link to={`/post/${post.id}`} className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF4E00]/80">
                        <div className={`${isLead ? 'aspect-[16/10] md:aspect-[21/10]' : 'aspect-[16/9]'} relative overflow-hidden bg-[#050517]`}>
                          {post.image ? (
                            <img
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-[radial-gradient(circle_at_30%_20%,rgba(255,78,0,0.22),transparent_34%),linear-gradient(135deg,#0a0a2e,#050517)]">
                              <img src="oko_logo.png" alt="" className="w-20 h-20 object-contain opacity-28" loading="lazy" />
                            </div>
                          )}
                          <div className="absolute inset-0 bg-gradient-to-t from-[#050517] via-[#050517]/18 to-transparent" />
                          <div className="absolute left-4 top-4 flex flex-wrap items-center gap-2">
                            <span className="border border-[#FF4E00]/45 bg-[#050517]/72 px-2.5 py-1 font-mono text-[9px] uppercase tracking-widest text-[#FF7A3D]">
                              {post.id}
                            </span>
                            <span className="border border-white/15 bg-[#050517]/58 px-2.5 py-1 font-mono text-[9px] uppercase tracking-widest text-white/68">
                              {post.date}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="p-5 md:p-6">
                          ...
                          <h3 className={`${isLead ? 'text-3xl md:text-5xl' : 'text-[1.7rem] md:text-[2rem]'} font-black uppercase tracking-tight mb-4 group-hover:text-[#FF7A3D] transition-colors leading-[1.02] text-white`}>
                            {post.title}
                          </h3>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {(post.tags || []).slice(0, isLead ? 6 : 4).map(tag => (
                              <span key={tag} className="px-2.5 py-1 border border-[#FF4E00]/20 font-mono text-[8px] tracking-widest uppercase text-[#FF4E00]/64 group-hover:border-[#FF4E00]/50 group-hover:text-[#FF7A3D] transition-all">
                                #{tag}
                              </span>
                            ))}
                          </div>
                      ...
                      <div className="mx-5 md:mx-6 mb-5 md:mb-6 flex flex-wrap items-center gap-3 border-t border-white/10 pt-4">
                        <button
                          ...
                          className="inline-flex min-h-11 items-center gap-1.5 border border-[#FF4E00]/25 bg-[#FF4E00]/8 px-3 py-2 font-mono text-[9px] uppercase tracking-widest text-white/62 hover:text-[#FF7A3D] hover:border-[#FF4E00]/55 hover:bg-[#FF4E00]/12 transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex min-h-11 items-center border border-white/10 px-3 py-2 font-mono text-[9px] uppercase tracking-widest text-white/48 hover:text-[#FF7A3D] hover:border-[#FF4E00]/45 transition-colors"
                        >
      ...
      {/* ── Footer ─────────────────────────────────────────────────────────── */}
      <footer id="contacts" className="relative overflow-hidden border-t border-[#FF4E00]/30 px-4 md:px-8 py-12 md:py-20 bg-[#050517] text-white scroll-mt-28">
        <div className="absolute inset-0 pointer-events-none opacity-35" style={{ backgroundImage: 'linear-gradient(rgba(255,78,0,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(255,78,0,0.08) 1px, transparent 1px)', backgroundSize: '42px 42px' }} />
        <div className="absolute -right-32 -bottom-32 w-[460px] h-[460px] rounded-full border border-[#FF4E00]/15 pointer-events-none" />
        <div className="max-w-[1800px] mx-auto relative">
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 md:gap-8 mb-8 md:mb-12">
            <div className="xl:col-span-5 border border-[#FF4E00]/25 bg-[#050517]/88 p-6 md:p-8">
              <div className="flex items-start gap-4 mb-7">
                <div className="w-12 h-12 md:w-14 md:h-14 border border-[#FF4E00]/40 bg-[#FF4E00]/10 flex items-center justify-center shrink-0">
                  <img src="oko_logo.png" alt="" className="w-8 h-8 md:w-10 md:h-10 object-contain opacity-90" loading="lazy" />
                </div>
                <div>
                  <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00]/75">/ ЦИФРОВА ПЛАТФОРМА КАНАЛУ</p>
                  <h3 className="mt-2 text-4xl md:text-6xl font-black tracking-tighter uppercase leading-[0.82] text-[#FF7A3D]">
                    Око Гора
                  </h3>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-7">
                {[
                  ...
                  <div key={label as string} className="border border-[#FF4E00]/16 bg-[#050517]/70 p-3 md:p-4">
            ...
            <div className="xl:col-span-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-[#FF4E00]/20 bg-[#050517]/72 p-5 md:p-6">
                <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00]/70 block mb-5">/ РОЗДІЛИ</span>
                <div className="grid grid-cols-1 gap-2 font-mono text-[11px] md:text-xs tracking-widest uppercase">
                  {[
                    ...
                    <button key={id} type="button" onClick={() => openSection(id as SectionId)} className="flex items-center justify-between gap-3 border-b border-white/10 py-2 text-left text-white/58 hover:text-[#FF7A3D] hover:border-[#FF4E00]/40 transition-colors">
                      <span>{label}</span>
                      <ArrowUpRight className="w-3 h-3 opacity-45" />
                    </button>
                  ))}
                  <Link to="/targets" className="flex items-center justify-between gap-3 border-b border-white/10 py-2 text-left text-[#FF7A3D] hover:border-[#FF4E00]/40 transition-colors">
              ...
              <div className="border border-[#FF4E00]/20 bg-[#050517]/72 p-5 md:p-6">
                <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF4E00]/70 block mb-5">/ ДЖЕРЕЛА</span>
                <div className="space-y-3 font-mono text-[11px] md:text-xs tracking-widest uppercase">
                  {[
                    ...
                    <a key={href} href={href} target="_blank" rel="noreferrer" className="flex items-center justify-between gap-3 border-b border-white/10 py-2 text-white/58 hover:text-[#FF7A3D] hover:border-[#FF4E00]/40 transition-colors">
                      <span>{label}</span>
            ...
            <div className="xl:col-span-3 border border-[#FF4E00]/25 bg-[#FF4E00]/10 p-5 md:p-6 flex flex-col justify-between gap-6">
              <div>
                <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#FF7A3D]/80">/ CONTACT</p>
              ...
              <div className="space-y-3">
                <a href="https://t.me/oko_gora" target="_blank" rel="noreferrer" className="flex items-center justify-between gap-3 bg-[#FF7A3D] text-[#050517] px-4 py-3 font-mono text-[11px] md:text-xs font-black uppercase tracking-widest hover:bg-white transition-colors">
                  Відкрити Telegram
                  <ArrowUpRight className="w-4 h-4" />
                </a>
                <button type="button" onClick={() => shareLink('footer-home', 'Око Гора', window.location.origin)} className="w-full flex items-center justify-between gap-3 border border-[#FF4E00]/40 px-4 py-3 font-mono text-[11px] md:text-xs font-black uppercase tracking-widest text-[#FF7A3D] hover:bg-[#FF4E00]/12 transition-colors">
          ...
          <div className="border-t border-[#FF4E00]/12 pt-5 md:pt-6 flex flex-col lg:flex-row justify-between gap-4 font-mono text-[9px] md:text-[10px] tracking-[0.22em] text-white/34 uppercase">
