...
export default function TargetsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050517] text-[#f4f4f4] selection:bg-[#f4f4f4] selection:text-[#0a0a0a]">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-[1000] border-b border-white/10 bg-[#050517]/90 backdrop-blur-md">
        <div className="grid grid-cols-2 md:grid-cols-4 px-4 md:px-8 py-3 md:py-4 text-[10px] md:text-xs font-mono uppercase tracking-widest items-center">
          <div className="col-span-1 flex items-center gap-3">
            ...
            <div className="w-4 h-4 bg-red-500 rounded-full flex items-center justify-center">
              <div className="w-1.5 h-1.5 bg-[#050517] rounded-full animate-pulse" />
            </div>
      ...
      <footer className="border-t border-white/10 px-4 md:px-8 py-12 bg-[#050517]">
